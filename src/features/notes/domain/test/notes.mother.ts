  ...
  static getNotes() {
    return [
      Note.fromPrimitives({
        ...
        creationDate: DateTime.fromIso("2022-07-15"),
        lastEditionDate: DateTime.fromIso("2022-07-15"),
      }),
      Note.fromPrimitives({
        id: "2",
        title: "Note 2",
        ...
        color: NoteColor.noteColors.PURPLE,
        creationDate: DateTime.fromIso("2023-08-09"),
        lastEditionDate: DateTime.fromIso("2023-08-09"),
      }),
      Note.fromPrimitives({
        id: "3",
        title: "Note 3",
        ...
        color: NoteColor.noteColors.YELLOW,
        creationDate: DateTime.fromIso("1997-05-03"),
        lastEditionDate: DateTime.fromIso("1997-05-03"),
      }),
    ];
  }
}
